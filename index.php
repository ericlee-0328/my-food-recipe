...
<body>
            ...
            <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h1 class="caption"><strong>What Is A Food Recipe System</strong></h5>
                            <p class="caption caption-p">A recipe management system is a software platform designed to streamline the process of creating, organizing, and sharing recipes. It provides a centralized hub for chefs and kitchen managers to manage all their recipes, including the ability to create and edit recipes, search and filter through them, and share them with team members.</p>
                        </div>
                    </div>
                    <div class="carousel-item">
                        <img src="image/bg5.jpg" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
                            <h1 class="caption"><strong>Feature highlights</strong></h1>
                            <p class="caption caption-p">Easy to create recipes from ingredients in the system<br>Allergen information<br>Versatile grouping options<br>Nutrition calculations</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section id="category">
        ...
        <!-- Category Area -->
        <div class="container mt-5">
            <header style="text-align: center; font-size: 50px;";> Category </header>
            <div class="row">
                <div class="col-md-4 mb-4">
                    <div class="card">
                        <img src="image/breakfast.jpg" class="card-img-top" alt="..." style="height: 240px">
                        <div class="card-body">
                            <h5 class="card-title text-center"><strong>Breakfast</strong></h5>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title text-center"><strong>Lunch</strong></h5>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title text-center"><strong>Dinner</strong></h5>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title text-center"><strong>Appetizer</strong></h5>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title text-center"><strong>Dessert</strong></h5>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title text-center"><strong>Fast Food</strong></h5>
